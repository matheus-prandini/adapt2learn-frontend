...
const QUESTIONS = [
  {
    id: 'q1',
    text: 'Você gostou das atividades matemáticas?',
    options: ['Muito', 'Mais ou menos', 'Não gostei'],
  },
  {
    id: 'q2',
    text: 'O nível de dificuldade foi adequado?',
    options: ['Fácil', 'Adequado', 'Difícil'],
  },
      ...
      <AppShell width="md" topbar={false}>
        <div style={{ display: 'grid', placeItems: 'center', minHeight: '70vh' }}>
          <Card hero className="a2l-anim-pop" style={{ textAlign: 'center', maxWidth: 440 }}>
            <span
              className="a2l-icon-chip a2l-icon-chip--lg a2l-icon-chip--solid"
  ...
  return (
    <AppShell width="md" back={-1}>
      <PageHead
        ...
        eyebrow={
          <>
            <LuMessageSquareHeart size={13} /> Sua opinião
          </>
        }
      ...
      <form
        ...
        className="a2l-stack a2l-anim-in a2l-delay-1"
        style={{ gap: 16 }}
      >
        {QUESTIONS.map((q, qi) => (
          <Card key={q.id}>
