...
export function useChartTheme() {
  ...
  return useMemo(() => {
    ...
    return {
      ...
      xAxis: { tick: { fill: colors.ink[500], fontSize: 12 }, tickLine: false, axisLine: { stroke: colors.line } },
      ...
      tooltip: {
        contentStyle: {
          ...
          boxShadow: getShadow(theme).lg, fontSize: 13, color: colors.ink[900],
        },
